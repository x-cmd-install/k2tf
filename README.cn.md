...
[![x-cmd/install — k2tf Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/k2tf.svg?lang=zh)](https://x-cmd.com/install/k2tf)
...
合计: **2,825** 行代码（覆盖前 5 种语言、共 **55** 个文件）。
...
- **Code-Review** (4/10) — Found 3/7 approved changesets -- score normalized to 4
...
- **Star**: 1,233 · **Fork**: 107 · **开放 issue**: 64 · **贡献者**: 10

## 累计统计

- **发布数**: 26 · **已合并 PR**: 61 · **开放 PR**: 9 · **已关闭 issue**: 45 · **开放 issue**: 19 · **提交数**: 238
...
| last720d | 2024-10-06 | 0 | 0 | 4 | 0 | 3 | 0 |
...
k2tf 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `k2tf` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/k2tf.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T05:03:22Z._
